      ...
      <h1 className='grid col-start-1 col-end-6 row-start-1 text-center text-xl font-bold'>Crear Pedido</h1>
        <div className='col-start-1 col-end-6 row-start-2 row-end-4 flex flex-col items-center'>
          ...
          <div className='flex flex-row w-full justify-center'>
            <button className='w-1/3 h-16 border rounded-l-2xl' onClick={(e) => handleClasico(e)} type='button' value='mas'>+</button>
            <p className='w-1/3 h-16 flex items-center justify-center font-semibold text-lg bg-white border '>{clasico}</p>
            <button className='w-1/3 h-16 border rounded-r-2xl' onClick={(e) => handleClasico(e)} type='button' value='menos'>-</button>
          </div>
            <div>
              <input checked={mediaDocenaClasico} onChange={handleClassicHalf} type='checkbox' />
        ...
        <div className='col-start-1 col-end-6 row-start-4 row-end-6 flex flex-col items-center'>
          ...
          <div className='flex flex-row w-full justify-center'>
            <button className='w-1/3 h-16 border rounded-l-2xl' onClick={(e) => handleSpecial(e)} type='button' value='mas'>+</button>
            <p className='w-1/3 h-16 flex items-center justify-center font-semibold text-lg bg-white border '>{special}</p>
            <button className='w-1/3 h-16 border rounded-r-2xl' onClick={(e) => handleSpecial(e)} type='button' value='menos'>-</button>
          </div>
            <div>
              <input checked={mediaDocenaSpecial} onChange={handleSpecialHalf} type='checkbox' />
              <label> Media Docena</label>
            </div>
        </div>
        <div className='col-start-1 col-end-6 row-start-6 row-end-8 flex flex-col items-center'>
          ...
          <div className='flex flex-row w-full justify-center'>
            <button className='w-1/3 h-16 border rounded-l-2xl' onClick={(e) => handleIndividualClassic(e)} type='button' value='mas'>+</button>
            <p className='w-1/3 h-16 flex items-center justify-center font-semibold text-lg bg-white border '>{individual}</p>
            <button className='w-1/3 h-16 border rounded-r-2xl' onClick={(e) => handleIndividualClassic(e)} type='button' value='menos'>-</button>
          </div>
        </div>
        <div className='col-start-1 col-end-6 row-start-8 row-end-10 flex flex-col items-center'>
          ...
          <div className='flex flex-row w-full justify-center'>
            <button className='w-1/3 h-16 border rounded-l-2xl' onClick={(e) => handleIndividualSpecial(e)} type='button' value='mas'>+</button>
            <p className='w-1/3 h-16 flex items-center justify-center font-semibold text-lg bg-white border '>{individualSpecial}</p>
            <button className='w-1/3 h-16 border rounded-r-2xl' onClick={(e) => handleIndividualSpecial(e)} type='button' value='menos'>-</button>
          </div>
        </div>
        <div className='col-start-1 col-end-6 row-start-10 flex flex-col'>
        <div>
          <input checked={mercadopago} onChange={handleMPCheckbox} type="checkbox" />
          <label htmlFor="">Pago con MercadoPago</label>
        </div>
        <button className='border rounded-lg' type='submit'>Enviar</button>
        </div>
      </form>
    </div>
  )
